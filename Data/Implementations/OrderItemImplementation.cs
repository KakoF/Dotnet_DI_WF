...
{
    public class OrderItemImplementation : Repository<OrderItem>, IOrderItemImplementation
    {
        public OrderItemImplementation(IDbConnector dbConnector) : base(dbConnector)
        {
        }
